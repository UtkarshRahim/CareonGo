...
"        <select id=\"sel\" name=\"product\" disabled>");  
...
//                     Statement stmt=conn.createStatement();
             ...
             ResultSet rs1 = stmt1.executeQuery("Select PRODUCT_NAME from products");
...
"          <option value =\"-1\">Dealer</option>");
             ...
             ResultSet rs = stmt2.executeQuery("Select SUPPLIER_NAME from suppliers");
             
         
                 while (rs.next()) {
                   name2=rs.getString("SUPPLIER_NAME"); 
             out.println("<option value =\""+name2+"\"> " + name2 +"</option></select>"); 
                  }
                 request.setAttribute("dname",dname);
                 
              out.println("<br><br>Batch number<br>\n" +
